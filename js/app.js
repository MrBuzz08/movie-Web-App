...
function getMovies(searchText) {
    ...
    axios.get(`http://www.omdbapi.com/?s=${searchText}&apikey=69f13631`).then(response => {
        console.log(response);
        let movies = response.data.Search;
        let output = "";
        movies.forEach(movie => { output += `
<div class="col-md-3">
...
function getMovie() {
    ...
    axios.get(`http://www.omdbapi.com/?i=${movieId}&apikey=69f13631`).then(response => {
        console.log(response);
